...
<head>
  ...
  <title>Student Result Analysis System | Add Subject Combination</title>
          ...
          <div class="col-lg-3">
            <div class="glass p-3 p-md-4 h-100">
              ...
              <div class="d-grid gap-2">
                ...
                <a class="quick-link active" href="add-subjectcombination.php"><i class="fa-solid fa-plus"></i><span>Add Subject Combination</span></a>
          ...
          <div class="col-lg-9">
            <div class="glass p-4 mb-4">
              <div class="page-header">
                <div>
                  <h2 class="mb-1">Add Subject Combination</h2>
                  <div class="opacity-75">Home / Subjects / Add Subject Combination</div>
                </div>
              </div>
            </div>
