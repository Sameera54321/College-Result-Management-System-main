...
<head>
  ...
  <title>Student Result Analysis System | Add Result</title>
  ...
  <style>
    ...
    .btn-primary:hover {
      background: linear-gradient(135deg,#3d8be6,#0055d4);
    }
          ...
          <div class="col-lg-3">
            <div class="glass p-3 p-md-4 h-100">
              ...
              <div class="d-grid gap-2">
                ...
                <a class="quick-link active" href="add-result.php"><i class="fa-solid fa-square-poll-horizontal"></i><span>Add Result</span></a>
          ...
          <div class="col-lg-9">
            <div class="glass p-4 mb-4">
              <div class="page-header">
                <div>
                  <h2 class="mb-1">Declare Result</h2>
                  <div class="opacity-75">Add student examination results</div>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                  <a href="manage-results.php" class="btn btn-light btn-sm rounded-pill"><i class="fa-solid fa-list me-1"></i> View Results</a>
                </div>
              </div>
            </div>
            ...
            <div class="glass p-4">
              ...
              <form method="post" class="row g-3">
                <div class="col-md-6">
                  ...
                  <select name="class" class="form-select clid" id="classid" onChange="getStudent(this.value);" required>
                ...
                <div class="col-md-6">
                  ...
                  <select name="studentid" class="form-select stid" id="studentid" required onChange="getresult(this.value);">
                ...
                <div class="col-12 text-end">
                  <button type="submit" name="submit" id="submit" class="btn btn-primary px-4 py-2">
