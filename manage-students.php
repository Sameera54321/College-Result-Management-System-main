...
<head>
  ...
  <title>Student Result Analysis System | Manage Students</title>
          ...
          <div class="col-lg-3">
            <div class="glass p-3 p-md-4 h-100">
              ...
              <div class="d-grid gap-2">
                ...
                <a class="quick-link active" href="manage-students.php"><i class="fa-solid fa-user-graduate"></i><span>Manage Students</span></a>
            ...
            <div class="glass p-4 mb-4">
              <div class="page-header">
                <div>
                  ...
                  <div class="opacity-75">View and manage all registered students</div>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                  <a href="add-students.php" class="btn btn-light btn-sm rounded-pill"><i class="fa-solid fa-user-plus me-1"></i> Add New Student</a>
                </div>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php } else { ?>
                          <span class="badge-blocked"><i class="fas fa-circle me-1" style="font-size: 8px;"></i> Blocked</span>
                        <?php } ?>
                      </td>
                      <td>
                        <a href="edit-student.php?stid=<?php echo htmlentities($result->StudentId);?>" class="action-btn" title="Edit Student">
