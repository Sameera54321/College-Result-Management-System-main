...
<head>
  ...
  <title>Student Result Analysis System | Manage Results</title>
          ...
          <div class="col-lg-9">
            <div class="glass p-4 mb-4">
              <div class="page-header">
                <div>
                  <h2 class="mb-1">Manage Results</h2>
                  <div class="opacity-75">View and manage all student results</div>
                </div>
                ...
                <table id="resultsTable" class="table table-hover w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit-result.php?stid=<?php echo htmlentities($result->StudentId);?>" class="action-btn" title="Edit Result">
