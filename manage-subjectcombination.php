...
<head>
  ...
  <title>Student Result Analysis System | Manage Subject Combinations</title>
...
<body class="top-navbar-fixed">
          ...
          <div class="col-lg-3">
            <div class="glass p-3 p-md-4 h-100">
              ...
              <div class="d-grid gap-2">
                ...
                <a class="quick-link active" href="manage-subjectcombination.php"><i class="fa-solid fa-diagram-project"></i><span>Manage Subject Combination</span></a>
          ...
          <div class="col-lg-9">
            <div class="glass p-4 mb-4">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h2 class="mb-1">Manage Subject Combinations</h2>
                  <div class="opacity-75">View and manage all subject combinations</div>
                </div>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="fa-solid fa-house me-1"></i> Home</a></li>
                    <li class="breadcrumb-item">Subjects</li>
                    <li class="breadcrumb-item active" aria-current="page">Manage Subject Combinations</li>
                  </ol>
                </nav>
              </div>
            </div>
            ...
            <div class="glass p-4">
              <div class="table-responsive">
                <table id="subjectCombinationsTable" class="table table-hover" style="width:100%">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Class & Section</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="badge rounded-pill <?php echo ($status == 1) ? 'badge-active' : 'badge-inactive'; ?>">
                      ...
                      <td>
                        <?php if($status == 0) { ?>
                          <a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid); ?>" 
                             ...
                             title="Activate"
                             onclick="return confirm('Do you really want to activate this subject combination?');">
                        ...
                        <?php } else { ?>
                          <a href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid); ?>" 
                             ...
                             title="Deactivate"
                             onclick="return confirm('Do you really want to deactivate this subject combination?');">
  ...
  <script>
    ...
    $(document).ready(function() {
      $('#subjectCombinationsTable').DataTable({
        responsive: true,
        language: {
          search: "_INPUT_",
          searchPlaceholder: "Search subject combinations...",
        }
      });
    });
  </script>
