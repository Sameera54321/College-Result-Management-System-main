...
<head>
  ...
  <title>Student Result Analysis System | Add Notice</title>
          ...
          <div class="col-lg-3">
            <div class="glass p-3 p-md-4 h-100">
              ...
              <div class="d-grid gap-2">
                ...
                <a class="quick-link active" href="add-notice.php"><i class="fa-solid fa-bullhorn"></i><span>Add Notice</span></a>
          ...
          <div class="col-lg-9">
            <div class="glass p-4 mb-4">
              <div class="page-header">
                <div>
                  <h2 class="mb-1">Add Notice</h2>
                  <div class="opacity-75">Create new notices for students</div>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                  <a href="manage-notices.php" class="btn btn-light btn-sm rounded-pill"><i class="fa-solid fa-list me-1"></i> View Notices</a>
                </div>
              </div>
            </div>
            ...
            <div class="glass p-4">
              ...
              <form method="post" class="row g-3">
                <div class="col-12">
                  ...
                  <input type="text" name="noticetitle" class="form-control" required id="noticetitle" placeholder="Enter notice title">
                </div>

                <div class="col-12">
                  <label for="noticedetails" class="form-label">Notice Details</label>
                  <textarea class="form-control form-textarea" name="noticedetails" required rows="5" placeholder="Enter notice details"></textarea>
                </div>
